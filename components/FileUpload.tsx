...
const FileUpload: React.FC<FileUploadProps> = ({ 
  ...
  return (
    <div 
      className={`relative w-full max-w-2xl mx-auto min-h-[12rem] border-2 border-dashed rounded-xl flex flex-col items-center justify-center transition-all duration-300 ${
        dragActive ? 'border-indigo-500 bg-indigo-50' : 'border-slate-300 bg-white'
        ...
        <label htmlFor={id} className="flex flex-col items-center cursor-pointer w-full h-full justify-center p-6 text-center">
            {acceptedFile ? (
              ...
              <>
                ...
                <p className="text-xs text-slate-500 mt-1">PDF, Word, Text, Images (Max 10MB)</p>
